...
select round(1.298), round(1.51111);

-- round(x, d) : d자리에 가장 급전한 실수;
select round(1.298,1), round(1.51111,0);
...
-- 가장 큰값, 가장 작은값
select greatest(10, 2, 4, 9), least(10, 2, 4, 9), greatest('Abc', 'Abc1', 'ABcd');